...
public class Scanner {
    ...
    public static class DiscoveredDevice {
        ...
        String driver = null;
        Map<String, String>/*<String,String>*/ properties = new HashMap<>/*<String,String>*/();
         ...
         */
        DiscoveredDevice(String drv, Map<String, String> props) {
            driver = drv;
            if (props != null) {
                properties = props;
            }
         ...
         */
        public Map<String, String>/*<String,String>*/ getProperties() {
            return properties;
        }
     ...
     */
    Map<String, String>/*<String,String>*/ config = null;
     ...
     */
    public Scanner(int scanType, Map<String, String>/*<String,String>*/ config) {
        this.scanType = scanType;
        this.config = config;
    }
    ...
    public String getExecName() {
        return config != null ? config.get(OPTION_SCANNER_EXEC) : null;
    }
    ...
    public String getExecPath() {
        return config != null ? config.get(OPTION_SCANNER_PATH) : null;
    }
    ...
    public void setParam(String name, String value) {
        if (config == null) {
            config = new HashMap<String, String>/*<String,String>*/();
        }
    ...
    DiscoveredDevice[] processScanResult(Process process) throws IOException {
        List<DiscoveredDevice>/*<DiscoveredDevice>*/ list = new ArrayList<>/*<DiscoveredDevice>*/();
    ...
    static DiscoveredDevice scanLine(String line) {
        String driver = null;
        Map<String, String> conf = new HashMap<String, String>/*<String,String>*/();
    ...
    String[] generateCommandParameters() {
        ArrayList<String>/*<String>*/ list = new ArrayList<>/*<String>*/();
        ...
        // Options
        Map<String, String>/*<String,String>*/ conf = getConfig();
        Set<Map.Entry<String, String>>/*<String,String>*/ set = conf != null ? conf.entrySet() : null;
        if (set != null) {
            Iterator<Map.Entry<String, String>> iter = set.iterator();
            while (iter.hasNext()) {
                Map.Entry<String, String>/*<String,String>*/ entry = iter.next();
                if (entry != null) {
